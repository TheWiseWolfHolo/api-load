...
// RedisKeyPrefix is the prefix for all Redis keys used by API-Load
const RedisKeyPrefix = "api-load:"
...
// Clear clears all keys with the API-Load prefix in the current Redis database.
// This method only removes keys that belong to API-Load, preserving other applications' data.
