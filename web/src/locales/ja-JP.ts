export default {
  ...
  resourcePools: {
    ...
    endpoints: "プロトコルエンドポイント",
    endpointsHelp: "各エンドポイントで API 形式と Base URL を定義し、下のキーを共有します。",
    addEndpoint: "エンドポイントを追加",
    addFirstEndpoint: "最初のエンドポイントを追加",
    editEndpoint: "エンドポイントを編集",
    noEndpoints: "プロトコルエンドポイントがありません。",
    endpointName: "エンドポイント名",
    endpointNamePlaceholder: "例: Official Anthropic",
    endpointChannel: "API 形式",
    endpointBaseURL: "Base URL",
    endpointBaseURLPlaceholder: "https://api.anthropic.com",
    endpointBaseURLHelp: "リクエストパスはこの URL の後ろに追加されます。",
    legacyEndpointNeedsChannel: "実際の API 形式を選択してください",
    endpointRequired: "名前、API 形式、Base URL を入力してください",
    deleteEndpointConfirm: "このエンドポイントを削除しますか？参照中の場合は拒否されます。",
    ...
    boundPool: "リソースプール",
    boundEndpoint: "プロトコルエンドポイント",
    selectEndpoint: "現在の API 形式に一致するエンドポイントを選択",
