export default {
  ...
  resourcePools: {
    ...
    boundPoolHelp:
      "This group defines only protocol and request behavior. The pool owns real URLs, keys, affinity, and failover.",
    legacyRoutingHelp:
      "Without a pool, this group continues to use its own upstreams and key list.",
    poolBoundKeys:
