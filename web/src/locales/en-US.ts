export default {
  ...
  resourcePools: {
    ...
    subtitle: "Share key health and scheduling while each protocol uses its own endpoint.",
    routingNote:
      "The pool is the only real-key scheduler. One key can serve multiple protocol endpoints; any failure except 404 disables that key globally.",
    ...
    empty: "No resource pools yet. Create one, then add protocol endpoints and shared keys.",
    name: "Name",
    ...
    endpointsHelp:
      "Each endpoint defines one protocol and base URL. All endpoints share the same keys below.",
    addEndpoint: "Add endpoint",
    addFirstEndpoint: "Add the first endpoint",
    editEndpoint: "Edit endpoint",
    noEndpoints: "No protocol endpoints yet. Groups cannot bind to this pool.",
    endpointName: "Endpoint name",
    endpointNamePlaceholder: "For example: Official Anthropic",
    endpointChannel: "API format",
    endpointBaseURL: "Base URL",
    endpointBaseURLPlaceholder: "https://api.anthropic.com",
    endpointBaseURLHelp:
      "The request path is appended to this URL. A fixed upstream path prefix is allowed.",
    legacyEndpointNeedsChannel: "choose the actual API format",
    endpointRequired: "Enter the endpoint name, API format, and base URL",
    deleteEndpointConfirm:
      "Delete this endpoint? The server refuses while groups or Batch/File objects reference it.",
    addResources: "Add resources",
    addFirstResource: "Add the first key",
    noResources: "No shared keys in this pool",
    manageResources: "Manage endpoints and keys",
    hideResources: "Hide endpoints and keys",
    searchPlaceholder: "Search name, or paste a full key for an exact match",
    noMatchingResources: "No matching resources",
    totalResources: "{count} shared keys",
    ...
    importHelp:
      "Paste keys directly. Separate them with new lines or commas; keys already in the pool are skipped.",
    ...
    resourceAppendResult: "Added {added} new keys; skipped {skipped} keys already in the pool.",
    ...
    importConfigHelp:
      "Paste exported JSONL or CSV. Key, enabled state, priority, and weight are restored; health and usage start fresh. Legacy upstream_url fields are ignored.",
    ...
    boundEndpoint: "Protocol endpoint",
    selectEndpoint: "Select an endpoint matching the current API format",
    selectPool: "Select a shared resource pool",
    legacyRouting: "Legacy group upstream + key",
    boundPoolHelp:
      "The pool selects the key and the chosen protocol endpoint supplies the base URL. Existing group upstreams stay dormant and resume when unbound.",
    legacyRoutingHelp:
